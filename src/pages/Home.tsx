import { Cpu, Smartphone, Code, BookOpen, Zap, Users, Terminal } from "lucide-react";
        ...
        {isMenuOpen && (
          <div
            className={`absolute bottom-16 right-0 bg-white p-4 rounded-lg shadow-lg border border-gray-200 ${
              accessibilityOptions.highContrast ? "bg-gray-900 text-yellow-300 border-yellow-300" : ""
            }`}
          >
