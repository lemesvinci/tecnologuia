    ...
    <>
      ...
      <section className="relative bg-gradient-to-r from-primary-600 to-primary-800 text-white py-24 md:py-32">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center md:text-left md:w-2/3">
            ...
            <p className="text-xl md:text-2xl text-gray-100 mb-8 animate-slide-up" style={{ animationDelay: '200ms' }}>
              Aprenda, explore e mantenha-se atualizado com as últimas novidades em tecnologia, programação e inovação.
            </p>
            <div className="flex flex-col sm:flex-row justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4 animate-slide-up" style={{ animationDelay: '400ms' }}>
              {isAuthenticated ? (
                ...
                <>
                  ...
                  <Link to="/login" className="btn-outline text-lg py-3 px-8 bg-white bg-opacity-20 text-white border-white">
                    Fazer Login
                  </Link>
                </>
              )}
      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-secondary-600 to-secondary-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Pronto para navegar pelo mundo da tecnologia?</h2>
